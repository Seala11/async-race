...
console.log(
  `%c При переключении между страницами, положения запущенных машинок сохраняются только после их остановки, в ТЗ про этот пункт ничего нет, данный вариант показался мне оптимальным. 
   Спасибо за проверку!`,
  'font-weight: bold;'
);
console.log(`
